...
impl StoreCache for RemindersCache {
    ...
    fn names(&self) -> &HashMap<String, String> { &self.lists }
    fn names_mut(&mut self) -> &mut HashMap<String, String> { &mut self.lists }
    fn items(&self) -> &HashMap<String, Self::Item> { &self.reminders }
    fn items_mut(&mut self) -> &mut HashMap<String, Self::Item> { &mut self.reminders }
    fn label() -> &'static str { "reminders" }
    fn meta_table() -> &'static str { "meta" }
    fn names_table() -> &'static str { "lists" }
    fn items_table() -> &'static str { "reminders" }
    fn missing_version_is_empty() -> bool { false }
    ...
    fn item_title(item: &ReminderData) -> &str { &item.title }
}
