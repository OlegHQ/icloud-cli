...
use crate::ast::types::{
    DoubleQuotedPart, EscapedPart, LiteralPart, ParameterExpansionPart, SingleQuotedPart, WordNode,
    WordPart,
};
...
pub fn expand_local_array_assignment(
    ...
    for part in &word.parts {
        match part {
            ...
            _ if in_array_content => match part {
...
fn expand_word_part_simple(ctx: &InterpreterContext, part: &WordPart) -> String {
    match part {
        ...
        WordPart::DoubleQuoted(DoubleQuotedPart { parts }) => parts
            .iter()
...
mod tests {
    ...
    fn test_array_assignment_empty_quoted_string() {
        ...
        let word = WordNode {
            parts: vec![
                ...
                WordPart::SingleQuoted(SingleQuotedPart {
                    value: "".to_string(),
                }),
                WordPart::Literal(LiteralPart {
                    value: " ".to_string(),
    ...
    fn test_array_assignment_keyed_element() {
        ...
        let word = WordNode {
            parts: vec![WordPart::Literal(LiteralPart {
                value: "arr=([0]=foo [1]=bar)".to_string(),
            })],
        };
