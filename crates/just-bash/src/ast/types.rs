...
impl AST {
    ...
    pub fn subshell(body: Vec<StatementNode>, redirections: Vec<RedirectionNode>) -> SubshellNode {
        SubshellNode { body, redirections }
    }

    pub fn group(body: Vec<StatementNode>, redirections: Vec<RedirectionNode>) -> GroupNode {
