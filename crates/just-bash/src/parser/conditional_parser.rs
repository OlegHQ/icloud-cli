...
use crate::ast::types::{
    CondAndNode, CondBinaryNode, CondBinaryOperator, CondGroupNode, CondNotNode, CondOrNode,
    CondUnaryNode, CondUnaryOperator, CondWordNode, ConditionalExpressionNode, LiteralPart,
    WordNode, WordPart,
};
...
pub struct CondParserContext<'a> {
    ...
    pub parse_word_from_string: &'a dyn Fn(&str, bool, bool, bool, bool, bool) -> WordNode,
