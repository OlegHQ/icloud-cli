...
use crate::commands::awk::variables::{delete_array, delete_array_element, set_variable};
...
fn execute_while(ctx: &mut AwkContext, condition: &AwkExpr, body: &AwkStmt, program: &AwkProgram) {
...
mod tests {
    ...
    fn test_for_loop() {
        ...
        let stmt = AwkStmt::For {
            ...
            update: Some(Box::new(AwkStmt::ExprStmt(AwkExpr::PostIncrement(
                Box::new(AwkExpr::Variable("i".to_string())),
            )))),
            body: Box::new(AwkStmt::ExprStmt(AwkExpr::Assignment {
