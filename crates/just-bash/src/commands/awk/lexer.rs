...
impl Lexer {
    ...
    fn read_identifier(&mut self) -> Token {
        ...
        while !self.at_end() && (self.peek(0).is_ascii_alphanumeric() || self.peek(0) == '_') {
        ...
        match ch {
            ...
            '&' => {
                if next == '&' {
                    ...
                    self.make_token(TokenType::Ident, "&".into(), start_line, start_column)
                }
            }
            '|' => {
                if next == '|' {
            ...
            _ => {
                ...
                self.make_token(TokenType::Ident, ch.to_string(), start_line, start_column)
            }
        }
    }
...
mod tests {
    ...
    fn test_regex_pattern() {
        ...
        assert_eq!(tokenize("/pattern/ { print }")[0].value, "pattern");
    }
